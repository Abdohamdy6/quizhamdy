...
export async function judgeAnswer(question, correctAnswer, playerAnswer) {
  try {
    ...
    // ج- استخدام Gemini للحالات الجدلية
...
1. الإجابة الناقصة عددياً: إذا كان السؤال يطلب صراحةً شيئين أو شخصين أو أكثر (مثل: "اذكر اسمين...") واللاعب ذكر اسماً واحداً فقط.
2. الأسماء والتواريخ والأرقام: يجب أن تكون دقيقة. لا تقبل اسماً مختلفاً لمجرد وجود تشابه في بعض الحروف.
3. التهرب والحديث الجانبي: أي إجابة تحتوي على عبارات تهرب مثل (لا أعرف، نسيت، ربما) أو مجرد تكرار للسؤال تعتبر خاطئة.
